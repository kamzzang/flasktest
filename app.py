...
# BlogPost.query.all()
# db.session.add(BlogPost(title='Blog Post 1', content='Content of Blog post 1.', author='MC'))
# db.session.add(BlogPost(title='Blog Post 2', content='Content of Blog post 2.'))
